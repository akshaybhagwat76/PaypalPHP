  ...
  <div id="main">
    ...
    <div id="site_content" class="container">
      ...
      <div id="content" class="auto-style1 col-12" ng-controller="formController" ng-cloak>
        <div>
          <label>Company Logo Or Personal Message</label>
          <div class="form-group">
            <div class="radio">
              <label><input type="radio" name="logo" ng-checked="true" id="rdcompanylogo" ng-model="data.logo" value="Comapny Logo" required>Comapny Logo</label>
            </div>
            <div class="radio">
              <label><input type="radio" name="logo" ng-model="data.logo" value="Personal Massage" required>Personal Massage</label>
            </div>
            <div class="col-12">
              <form name="paypal" action=<?php if (!$errors && isset($_POST['submit'])) {
                                            echo $paypal_url;
                                          } else {
                ...
                <div class="form-group" ng-if="data.logo != 'Personal Massage'" ng-class="{ 'has-error' : paypal.coname.$invalid && !paypal.coname.$pristine }">
                ...
                <div id="companyLogo" ng-if="data.logo != 'Personal Massage'">
        ...
        <div class="help-block" ng-messages="paypal.charity.$error" ng-if="formSubmited && !data.charity">
            <p class="text-danger" ng-message="required">Select an option.</p>
                ...
                <div class="form-group" ng-class="{ 'has-error' : (paypal.checkbox.$invalid )}">
                  <label>
                    <input name="checkbox" type="checkbox" required ng-model="data.checkbox" ng-true-value="'on'" ng-false-value="">
